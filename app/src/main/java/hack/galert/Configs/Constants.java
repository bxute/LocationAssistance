...
public class Constants {
    ...
    public static final String SERVER_URL_LOGIN = "http://awasthikamal97.pythonanywhere.com/location/login";
    ...
    public static final String SERVER_URL_REGISTER = "http://awasthikamal97.pythonanywhere.com/location/registration";
